...
namespace DNS.CommonExtensions
{
    ...
    public static class AssemblyExtensions
    {
        ...
        public static Type[] GetGenericInterfaceImplementationTypes(this Assembly[] assemblies,
            Type openGenericInterfaceType)
        {
            return assemblies.SelectMany(asm => GetGenericInterfaceImplementationTypes(asm, openGenericInterfaceType))
                .ToArray();
        }
        ...
        /// <param name="openGenericInterfaceType">Type of the open generic</param>
        /// <returns>Collection of concrete types</returns>
        public static Type[] GetGenericInterfaceImplementationTypes(this Assembly assembly,
            Type openGenericInterfaceType)
        {
